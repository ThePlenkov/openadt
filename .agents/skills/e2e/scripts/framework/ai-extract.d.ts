 ...
 */
export declare function extractParamsFromPrompt(prompt: string, ctx: RunContext): ExtractedParams
/**
 ...
 */
export declare function mergeExtractedParams(
  ctx: RunContext,
  extracted: ExtractedParams
): RunContext
//# sourceMappingURL=ai-extract.d.ts.map
