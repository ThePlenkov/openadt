...
const launcher = join(repoRoot, 'tools', 'sap-adt-mcp-launcher', 'src', 'cli', 'main.ts')
...
setTimeout(() => {
  ...
  console.log('(SAP operations may have timed out - check for SSO/Secure Login windows)')
  child.kill()
  process.exit(1)
}, 300_000)
